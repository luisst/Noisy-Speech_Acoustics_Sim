...
def merge_x4_pyroom(current_folder_path,
    ...
    print(f'Current folder: {current_folder_path}')
...
def create_dicts(transcr_path, dicts_path, dataset_name, lang_ph):
    if lang_ph == 'EN':
        L = 'en-us'
    elif lang_ph == 'ES':
        L = 'es-419'
...
def create_dicts_v2(transcr_path, dicts_path, dataset_name, lang_ph):
    if lang_ph == 'EN':
        L = 'en-us'
    elif lang_ph == 'ES':
        L = 'es-419'
