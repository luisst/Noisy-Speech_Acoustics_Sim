...
from DA_pyroom7 import DAwithPyroom
...
all_params = { # Set to 0 to have only bk_speakers
                ...
                'rnd_offset_secs' : (8, False), # max silence between speech segments 
                'bk_num' :      (3, True), # bk_speakers_number
                ...
                'ns_gain' :           (0.3, True), 
                'ns_gain_away' :      (0.4, False),
                'ns_gain_range' :     ([0.2, 0.4], False),
