...
from DA_pyroom7_dt import DAwithPyroom
...
all_params = { # Set to 0 to have only bk_speakers
                ...
                'length_minutes' :     (9, False), # Length of output audios (min)
                'pattern_flag': (True, False), # Use pattern for conversation speakers
                'double_talk_flag': (True, False), # Use double talk simulation
...
run_name = 'TTS3_dt_test'

FOLDER_WAV_BASE = Path.home().joinpath('Dropbox','DATASETS_AUDIO')
INPUT_WAV_PATH = FOLDER_WAV_BASE.joinpath('TTS3_dt','input_TTS3_chopped_all')
ORDERED_SPEECH_TXT = INPUT_WAV_PATH.joinpath('balanced_dataset_min100_bal200.txt')
